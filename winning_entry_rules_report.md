...
Период: **336 ч** | Сгенерировано: 2026-06-26T16:36:55.739252+00:00

## Сводка исходов
- **Профит:** 787
- **Убыток:** 706
- **Безубыток / нейтраль:** 2359
- TP (вирт + биржа): **787** (вирт 686, биржа 101)

## Рекомендации по весам и фильтрам
- 🗑 Рассмотреть отказ `skip:макс. позиций` (high, n=185): Фильтр «макс. позиций» отсек 185 сигналов; 67% дошли бы до TP — возможно слишком жёстко.
