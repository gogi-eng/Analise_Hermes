...
Период: **336 ч** | Сгенерировано: 2026-06-24T12:43:02.421356+00:00

## Сводка исходов
- **Профит:** 673
- **Убыток:** 588
- **Безубыток / нейтраль:** 1964
- TP (вирт + биржа): **673** (вирт 609, биржа 64)
...
- 🗑 Рассмотреть отказ `skip:дневной лимит убытка 16.3% (лимит 5%). н` (high, n=3): Фильтр «дневной лимит убытка 16.3% (лимит 5%). н» отсек 3 сигналов; 100% дошли бы до TP — возможно слишком жёстко.
