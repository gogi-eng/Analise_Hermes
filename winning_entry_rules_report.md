...
Период: **336 ч** | Сгенерировано: 2026-06-22T17:35:38.504559+00:00

## Сводка исходов
- **Профит:** 582
- **Убыток:** 466
- **Безубыток / нейтраль:** 1641
- TP (вирт + биржа): **582** (вирт 536, биржа 46)
...
- 🗑 Рассмотреть отказ `skip:на бирже уже открыта позиция solusdt — н` (high, n=66): Фильтр «на бирже уже открыта позиция solusdt — н» отсек 66 сигналов; 85% дошли бы до TP — возможно слишком жёстко.
...
- **на бирже уже открыта позиция solusdt — н**: n=66, вирт.TP=85% (+22/−4/≈40) — Фильтр «на бирже уже открыта позиция solusdt — н» отсек 66 сигналов; 85% дошли бы до TP — возможно слишком жёстко.
