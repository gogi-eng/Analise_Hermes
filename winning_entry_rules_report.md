...
Период: **336 ч** | Сгенерировано: 2026-06-26T14:25:05.253328+00:00

## Сводка исходов
- **Профит:** 786
- **Убыток:** 700
- **Безубыток / нейтраль:** 2318
- TP (вирт + биржа): **786** (вирт 685, биржа 101)
...
- 🗑 Рассмотреть отказ `skip:на бирже уже открыта позиция solusdt — н` (high, n=97): Фильтр «на бирже уже открыта позиция solusdt — н» отсек 97 сигналов; 84% дошли бы до TP — возможно слишком жёстко.
