...
Период: **336 ч** | Сгенерировано: 2026-06-26T22:12:16.839073+00:00

## Сводка исходов
- **Профит:** 774
- **Убыток:** 715
- **Безубыток / нейтраль:** 2335
- TP (вирт + биржа): **774** (вирт 671, биржа 103)

## Рекомендации по весам и фильтрам
- 🗑 Рассмотреть отказ `skip:макс. позиций` (medium, n=124): Фильтр «макс. позиций» отсек 124 сигналов; 59% дошли бы до TP — возможно слишком жёстко.
...
- 🗑 Рассмотреть отказ `skip:на бирже уже открыта позиция solusdt — н` (high, n=98): Фильтр «на бирже уже открыта позиция solusdt — н» отсек 98 сигналов; 84% дошли бы до TP — возможно слишком жёстко.
...
- `adx_ok` (soft_rule): WR **39%** (lift -6%), +7/−11/≈5
- `atr_sweet` (soft_rule): WR **37%** (lift -8%), +7/−12/≈5
- `volume_2x` (soft_rule): WR **37%** (lift -8%), +7/−12/≈5
