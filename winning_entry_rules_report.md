...
Период: **336 ч** | Сгенерировано: 2026-06-24T01:02:15.463635+00:00

## Сводка исходов
- **Профит:** 662
- **Убыток:** 566
- **Безубыток / нейтраль:** 1884
- TP (вирт + биржа): **662** (вирт 603, биржа 59)
...
- 🗑 Рассмотреть отказ `skip:на бирже уже открыта позиция ethusdt — н` (high, n=89): Фильтр «на бирже уже открыта позиция ethusdt — н» отсек 89 сигналов; 96% дошли бы до TP — возможно слишком жёстко.
...
- **на бирже уже открыта позиция ethusdt — н**: n=89, вирт.TP=96% (+22/−1/≈66) — Фильтр «на бирже уже открыта позиция ethusdt — н» отсек 89 сигналов; 96% дошли бы до TP — возможно слишком жёстко.
