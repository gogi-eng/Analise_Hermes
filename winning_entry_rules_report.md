...
Период: **336 ч** | Сгенерировано: 2026-06-22T20:48:48.151173+00:00

## Сводка исходов
- **Профит:** 583
- **Убыток:** 468
- **Безубыток / нейтраль:** 1650
- TP (вирт + биржа): **583** (вирт 536, биржа 47)
...
- `adx_ok` (soft_rule): WR **33%** (lift -6%), +5/−10/≈4
- `atr_sweet` (soft_rule): WR **33%** (lift -6%), +5/−10/≈4
- `volume_2x` (soft_rule): WR **33%** (lift -6%), +5/−10/≈4
...
- `adx_low` (indicator): WR **14%** (lift -25%), +1/−6/≈2
- `volume_24h_usdt_high` (indicator): WR **17%** (lift -23%), +1/−5/≈4
- `rsi_high` (indicator): WR **29%** (lift -11%), +2/−5/≈3
