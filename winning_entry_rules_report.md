...
Период: **336 ч** | Сгенерировано: 2026-06-24T21:12:02.455689+00:00
...
- `regime_chop` (soft_rule): WR **40%** (lift -4%), +2/−3/≈2
- `adx_strong` (soft_rule): WR **40%** (lift -4%), +4/−6/≈3
...
- `spread_wide` (soft_rule): WR **20%** (lift -24%), +1/−4/≈0
- `local_hour_low` (indicator): WR **0%** (lift -44%), +0/−4/≈2
- `adx_low` (indicator): WR **25%** (lift -19%), +2/−6/≈2
- `normalized_imbalance_high` (indicator): WR **29%** (lift -16%), +2/−5/≈3
- `atr_pct_high` (indicator): WR **30%** (lift -14%), +3/−7/≈0
- `spread_pct_high` (indicator): WR **30%** (lift -14%), +3/−7/≈0
