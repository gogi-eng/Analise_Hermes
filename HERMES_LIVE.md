---
hermes_feed: true
generated_at: 2026-06-27T18:33:47.570447+00:00
fingerprint: d5a00ad4038f46cc
source: AGENT-WORLD
...
**Обновлено:** 2026-06-27T18:33:47.570447+00:00 | окно **336 ч** | id `d5a00ad4038f46cc`
...
TP всего: **780** (вирт 672, биржа 108) | SL/убытки: **597**

## ⚡ Одна гипотеза (ZeroOne) — приоритет для агента

**Рассмотреть отказ от фильтра** фильтр/правило `skip:на бирже уже открыта позиция ethusdt — н`
- Уверенность: high, выборка n=147
- Почему: Фильтр «на бирже уже открыта позиция ethusdt — н» отсек 147 сигналов; 86% дошли бы до TP — возможно слишком жёстко.

## Рекомендации по весам и фильтрам

- **Рассмотреть отказ от фильтра** `skip:на бирже уже открыта позиция btcusdt — н` (medium, n=362): Фильтр «на бирже уже открыта позиция btcusdt — н» отсек 362 сигналов; 60% дошли бы до TP — возможно слишком жёстко.
...
- **Рассмотреть отказ от фильтра** `skip:макс. позиций` (high, n=38): Фильтр «макс. позиций» отсек 38 сигналов; 74% дошли бы до TP — возможно слишком жёстко.
