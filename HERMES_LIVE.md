---
hermes_feed: true
generated_at: 2026-06-27T12:58:17.658850+00:00
fingerprint: e2d35a9719f1c3c4
source: AGENT-WORLD
...
**Обновлено:** 2026-06-27T12:58:17.658850+00:00 | окно **336 ч** | id `e2d35a9719f1c3c4`
...
TP всего: **778** (вирт 673, биржа 105) | SL/убытки: **590**
...
- Уверенность: high, выборка n=137
- Почему: Фильтр «на бирже уже открыта позиция ethusdt — н» отсек 137 сигналов; 89% дошли бы до TP — возможно слишком жёстко.

## Рекомендации по весам и фильтрам

- **Рассмотреть отказ от фильтра** `skip:на бирже уже открыта позиция btcusdt — н` (medium, n=362): Фильтр «на бирже уже открыта позиция btcusdt — н» отсек 362 сигналов; 61% дошли бы до TP — возможно слишком жёстко.
- **Рассмотреть отказ от фильтра** `skip:на бирже уже открыта позиция ethusdt — н` (high, n=137): Фильтр «на бирже уже открыта позиция ethusdt — н» отсек 137 сигналов; 89% дошли бы до TP — возможно слишком жёстко.
- **Рассмотреть отказ от фильтра** `skip:на бирже уже открыта позиция solusdt — н` (high, n=94): Фильтр «на бирже уже открыта позиция solusdt — н» отсек 94 сигналов; 90% дошли бы до TP — возможно слишком жёстко.
- **Рассмотреть отказ от фильтра** `skip:макс. позиций` (high, n=63): Фильтр «макс. позиций» отсек 63 сигналов; 80% дошли бы до TP — возможно слишком жёстко.
