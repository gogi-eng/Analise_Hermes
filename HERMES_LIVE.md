---
hermes_feed: true
generated_at: 2026-06-26T17:15:36.941700+00:00
fingerprint: 27162f6722a551ba
source: AGENT-WORLD
...
**Обновлено:** 2026-06-26T17:15:36.941700+00:00 | окно **336 ч** | id `27162f6722a551ba`
...
TP всего: **787** (вирт 686, биржа 101) | SL/убытки: **578**

## ⚡ Одна гипотеза (ZeroOne) — приоритет для агента

**Рассмотреть отказ от фильтра** фильтр/правило `skip:макс. позиций`
- Уверенность: high, выборка n=185
- Почему: Фильтр «макс. позиций» отсек 185 сигналов; 67% дошли бы до TP — возможно слишком жёстко.

## Рекомендации по весам и фильтрам

- **Рассмотреть отказ от фильтра** `skip:макс. позиций` (high, n=185): Фильтр «макс. позиций» отсек 185 сигналов; 67% дошли бы до TP — возможно слишком жёстко.
