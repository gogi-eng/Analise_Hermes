---
hermes_feed: true
generated_at: 2026-06-27T16:11:47.151325+00:00
fingerprint: d2a088b8aadc0b74
source: AGENT-WORLD
...
**Обновлено:** 2026-06-27T16:11:47.151325+00:00 | окно **336 ч** | id `d2a088b8aadc0b74`
...
TP всего: **767** (вирт 662, биржа 105) | SL/убытки: **591**
...
- Уверенность: high, выборка n=146
- Почему: Фильтр «на бирже уже открыта позиция ethusdt — н» отсек 146 сигналов; 89% дошли бы до TP — возможно слишком жёстко.

## Рекомендации по весам и фильтрам

- **Рассмотреть отказ от фильтра** `skip:на бирже уже открыта позиция btcusdt — н` (medium, n=361): Фильтр «на бирже уже открыта позиция btcusdt — н» отсек 361 сигналов; 61% дошли бы до TP — возможно слишком жёстко.
- **Рассмотреть отказ от фильтра** `skip:на бирже уже открыта позиция ethusdt — н` (high, n=146): Фильтр «на бирже уже открыта позиция ethusdt — н» отсек 146 сигналов; 89% дошли бы до TP — возможно слишком жёстко.
