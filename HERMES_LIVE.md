---
hermes_feed: true
generated_at: 2026-06-27T00:50:27.951170+00:00
fingerprint: a4fc3b6008c7bdc7
source: AGENT-WORLD
...
**Обновлено:** 2026-06-27T00:50:27.951170+00:00 | окно **336 ч** | id `a4fc3b6008c7bdc7`
...
TP всего: **775** (вирт 671, биржа 104) | SL/убытки: **590**
...
- Уверенность: high, выборка n=120
- Почему: Фильтр «на бирже уже открыта позиция ethusdt — н» отсек 120 сигналов; 89% дошли бы до TP — возможно слишком жёстко.

## Рекомендации по весам и фильтрам

- **Рассмотреть отказ от фильтра** `skip:макс. позиций` (medium, n=124): Фильтр «макс. позиций» отсек 124 сигналов; 59% дошли бы до TP — возможно слишком жёстко.
- **Рассмотреть отказ от фильтра** `skip:на бирже уже открыта позиция ethusdt — н` (high, n=120): Фильтр «на бирже уже открыта позиция ethusdt — н» отсек 120 сигналов; 89% дошли бы до TP — возможно слишком жёстко.
