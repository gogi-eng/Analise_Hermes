...
Наибольшее количество убытков (`25`) зафиксировано в час `UTC 01:00` (`Местное время 04:00`). Соответствующие торговые сессии: `Азиатская (Токио-Сидней)`. Рекомендуется присмотреться к этому интервалу.